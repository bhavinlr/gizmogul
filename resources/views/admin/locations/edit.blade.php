                    ...
                    <div class="card-body">
                        ...
                        <form id="LocationForm" class="needs-validation" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="row justify-content-end">
                                <div class="col-lg-10">
                                    <button type="submit"
                                        class="btn btn-{{ $location ? 'success' : 'primary' }}">{{ $location ? 'Update Vendor' : 'Create Vendor' }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
